...
INSERT INTO `User` (`id`, `name`, `email`, `password`, `phone`, `profilePicUrl`, `role`, `universityId`, `vendorDescription`, `createdAt`) VALUES
('student-1', 'Test Student 1', 'student1@foodzie.com', '$2y$12$R.b2wex/X4041d8e13295982v2.C2gU.86nF5S8i9jXgP9eK.vGde', '+919999999991', NULL, 'Student', 'uni-1', NULL, NOW(3)),
('student-2', 'Test Student 2', 'student2@foodzie.com', '$2y$12$R.b2wex/X4041d8e13295982v2.C2gU.86nF5S8i9jXgP9eK.vGde', '+919999999992', NULL, 'Student', 'uni-2', NULL, NOW(3)),
('vendor-1', 'Haldirams Canteen', 'haldirams@foodzie.com', '$2y$12$R.b2wex/X4041d8e13295982v2.C2gU.86nF5S8i9jXgP9eK.vGde', '+919999999993', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&q=80&w=800', 'Vendor', 'uni-1', 'Traditional Indian sweets, street chaats, and full lunch thalis.', NOW(3)),
('vendor-2', 'Dominos Express', 'dominos@foodzie.com', '$2y$12$R.b2wex/X4041d8e13295982v2.C2gU.86nF5S8i9jXgP9eK.vGde', '+919999999994', 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=800', 'Vendor', 'uni-1', 'Hot and fresh pizzas made to order.', NOW(3));
